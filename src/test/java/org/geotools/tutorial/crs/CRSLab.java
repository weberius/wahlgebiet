...
public class CRSLab {
	...
	private void exportToShapefile() throws Exception {
		...
		// To create a new shapefile we will need to produce a FeatureType that
		// is similar to our original. The only difference will be the
		...
		// We can now carefully open an iterator to go through the contents, and
		// a writer to write out the new Shapefile.
