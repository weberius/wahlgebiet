...
/**
 * This example shows how to perform some common JTS Geometry tasks as per
 * <a href="http://docs.codehaus.org/display/GEOTDOC/03+JTS+Topology+Suite">JTS
 * Topology Suite</a>.
 * <p>
 * The <b>JTS Topology Suite</b> is a library of topology abstractions and
 * operations used by GeoTools to represent "Simple Feature for SQL" constructs
 * like Point, Line and Polygon. GeoTools itself includes an "ISO Geometry"
 * module representing Point, Curve and Surface.
 * <p>
